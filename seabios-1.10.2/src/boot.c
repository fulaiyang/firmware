...
interactive_bootmenu(void)
{
    ...
    /* derectly printf the logo utill the windows vga update */
    enable_bootsplash();
    /* if not return,it will wait utill the boot menu time out */
    /* After return,it can not check the key status */
    return;
